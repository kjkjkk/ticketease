...
<div id="reminder" class="reminder-modal">
    <div class="reminder-container">
        ...
        <div class="modal-body reminders-content">
            ...
            <p>There are <strong class="text-primary">{{ count($tickets) }} tickets</strong> in queue:</p>
            @if(count($tickets) != 0)
            <ol class="list-group list-group-numbered ticket-list n-mt-2">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    ...
                    <span class="badge text-bg-primary rounded-pill">{{ $ticket->created_at->diffForHumans() }}</span>
                </li>
                @endforeach
            </ol>
